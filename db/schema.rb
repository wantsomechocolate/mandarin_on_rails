...
ActiveRecord::Schema[7.0].define(version: 2022_10_17_110257) do
  ...
  create_table "garbage_words", force: :cascade do |t|
    t.bigint "user_id"
    t.string "word"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_garbage_words_on_user_id"
    t.index ["word"], name: "index_garbage_words_on_word"
  end
  ...
  add_foreign_key "garbage_words", "users"
